...
for var_name, var_data in data_vars.items():
    ...
    # Decompose scales
    large, medium, small = decompose_scales(data)
...
# Save files
large_ds.to_netcdf(os.path.join(output_dir, "large_scale_output.nc"))
medium_ds.to_netcdf(os.path.join(output_dir, "medium_scale_output.nc"))
small_ds.to_netcdf(os.path.join(output_dir, "small_scale_output.nc"))
